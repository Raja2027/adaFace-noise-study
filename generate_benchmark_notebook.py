    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "    raise RuntimeError(f\"Drive directory {drive_dataset} does not exist! Please check your mount.\")\n",
                "if not (drive_dataset / \"splits/100k/master_100k.csv\").exists():\n",
                "    raise RuntimeError(f\"master_100k.csv not found in {drive_dataset}! Dataset not properly uploaded.\")\n",
