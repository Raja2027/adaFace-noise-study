    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "source_dir = Path(\"/content/adaFace-noise-study/data\")\n",
                "drive_dest = Path(\"/content/drive/MyDrive/adaFace-noise-study/data\")\n",
                "\n",
                "print(f\"Copying generated dataset from {source_dir} to {drive_dest} ...\")\n",
                "print(\"NOTE: Copying 200,000+ files directly to Google Drive can take a very long time.\")\n",
                "\n",
                "if not source_dir.exists():\n",
                "    print(\"ERROR: Source directory does not exist! Did the dataset generation run?\")\n",
                "else:\n",
                ...
                "    \n",
                "    for src_file in tqdm(all_files, desc=\"Copying files\"):\n",
                "        rel_path = os.path.relpath(src_file, source_dir)\n",
                "        dst_file = drive_dest / rel_path\n",
...
with open("colab_generate_100k.ipynb", "w") as f:
